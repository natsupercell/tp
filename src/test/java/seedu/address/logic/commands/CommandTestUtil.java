...
public class CommandTestUtil {
    ...
    public static final String INVALID_ROLE_DESC = " " + PREFIX_ROLE + " "; // empty space not allowed in role
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withRole(VALID_ROLE_AMY).withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withRole(VALID_ROLE_BOB).withName(VALID_NAME_BOB)
